...
# 示例使用
root_directory = '/remote-home1/share/data/SpeechPretrain/librispeech/LibriSpeech/'
output_tsv = 'LibriSpeech_all_audio_path.txt'
exclude_folders = ['/remote-home1/share/data/SpeechPretrain/librispeech/LibriSpeech/test-clean']
